...
export_insee_stats_locales_2 <- export_insee_stats_locales_1 %>%
  rename(
    ...
    RATIO_DECILE_9_1_2021 = "Rapport interdécile du niveau de vie (9e déc./1er déc.) 2021",
    SALAIRE_MOYEN_2023 = "Salaire net EQTP mensuel moyen 2023",
    TX_ACTIVITE_2022 = "Taux d'activité par tranche d'âge 2022",
    NB_EMPLOIS_2022 = "Nb d'emplois au lieu de travail (LT) 2022",
    PART_MONOPAR_2022 = "Part des familles monoparentales 2022",
